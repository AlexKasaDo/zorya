    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row justify-content-between">
                <div class="col-auto">
                    <a class="navbar-brand" href="/"><img alt=""  src="img/demo/dark-version//logos/logo-slider-white.png" alt=""></a>
                    <a class="navbar-brand black" href="/"><img alt=""  src="img/demo/dark-version//logos/logo-slider-black.png" alt=""></a>
                </div>
                <div class="d-flex justify-content-center onlydesktop">
                    <ul class="navbar">
                        ...
                        <li ><a class="animatedScroll nav-link active"  href="#section-gallery" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Галерея</a></li>
                        <li><a class="nav-link" href="new.php">Новинки</a></li>
