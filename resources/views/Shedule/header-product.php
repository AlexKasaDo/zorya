...
зроби ваше життя щасливішим! &hellip;">
    ...
    <link rel="stylesheet" href="vendor/jquery/jquery.timepicker.css">
...
<body id="page-top" class="bodypadding dark-version">
<!-- Start  Loading Mask-->
<div id="mask">
...
<header class="container-fluid header js-header-fixsmall overlayer-fixed">
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row justify-content-between">
                <div class="col-auto">
                    <a class="navbar-brand" href="/"><img alt="" src="../../../public/img/demo/dark-version//logos/logo-slider-white.png" alt=""></a>
                    <a class="navbar-brand black" href="/"><img alt="" src="../../../public/img/demo/dark-version//logos/logo-slider-black.png" alt=""></a>
                </div>
                <div class="d-flex justify-content-center onlydesktop">
                    <ul class="navbar">
                        <li><a href="/" class=" nav-link ">Головна</a></li>
                        <li class="nav-item dropdown" ><a class="nav-link dropdown-toggle active"  href="section-menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Продукція</a>
                        ...
                        <li ><a class="nav-link"  href="../galler.blade.php" >Галерея</a></li>
                        <li><a class="nav-link" href="../new.blade.php">Новинки</a></li>
    ...
    <div class="overlay overlay-hugeinc">
        <div class="overlay-content"><span class="trigger-overlay"></span>
            <nav id="nav">
                <ul>
                    <li class="current"><a href="index.php" class="animatedScroll">Головна</a></li>
                    <li><a href="/" >Продукція</a></li>
                    <li><a href="../galler.blade.php" >Галерея</a></li>
                    <li><a href="../new.blade.php" >Новинки</a></li>
